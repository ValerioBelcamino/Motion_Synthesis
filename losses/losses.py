...
class CrossModalLosses(nn.Module):
    ...
    def kl_divergence_loss(self, dist_T, dist_M):
        ...
        # Total KL loss
        return (kl_T_M + kl_M_T + kl_T_prior + kl_M_prior).mean()
    ...
    def forward(self, dist_T, dist_M, z_t, z_m, H_gt, H_hat_T, H_hat_M):
        ...
        reconstruction_loss = self.reconstruction_loss(H_gt, H_hat_T, H_hat_M)
